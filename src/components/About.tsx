      ...
      <div className="container-section">
        ...
        <div className="flex flex-col lg:flex-row lg:gap-12 lg:items-start">
          <div className="flex-1 max-w-2xl space-y-6 mb-12 lg:mb-0">
            ...
            профессионального становления — от помощника машиниста до генерального
            директора, — и обрести непререкаемый авторитет. Мы — специализированная
            буровая компания, которая объединяет технологическую оснащённость,
            профессиональную команду и многолетний опыт работы на объектах различного
            масштаба.
          </p>
